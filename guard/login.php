...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT * FROM guards WHERE employee_id = ?");
    ...
    <div class="auth-container guard-theme-auth">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <h1 class="auth-title">Security Guard</h1>
                <p class="auth-subtitle">Sign in to access scanner</p>
            </div>
            ...
            <div class="auth-links">
                <a href="signup.php">Create Guard Account →</a>
            </div>
        </div>
    </div>
</body>
