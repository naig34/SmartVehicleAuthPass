...
<head>
    ...
    <title>Teacher/Staff Login</title>
...
<body>
    ...
    <div class="auth-container teacher-theme-auth">
        <div class="auth-card">
            <div class="auth-header">
                <div class="auth-icon">👨‍🏫</div>
                <h1 class="auth-title">Teacher / Staff</h1>
            ...
            <form method="POST" class="auth-form">
                ...
                <div style="text-align:right;margin-top:-10px;margin-bottom:18px;">
                    <a href="../forgot_password/request.php?type=teacher"
