...
$guards = $pdo->query("SELECT * FROM guards ORDER BY name ASC")->fetchAll();
...
<head>
    ...
    <style>
        .page-header-info { background: linear-gradient(135deg, #8b5cf6, #a78bfa); color: white; padding: 20px 28px; border-radius: 14px; margin-bottom: 24px; }
        .page-header-info h2 { font-size: 1.5rem; font-weight: 800; }
        .page-header-info p { opacity: 0.85; margin-top: 4px; }
        .back-btn { display: inline-flex; align-items: center; gap: 6px; padding: 8px 16px; background: white; color: #8b5cf6; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 0.9rem; border: 2px solid #8b5cf6; transition: all 0.2s; margin-bottom: 20px; }
        .back-btn:hover { background: #8b5cf6; color: white; }
        .guard-avatar { width: 50px; height: 50px; border-radius: 50%; background: linear-gradient(135deg,#8b5cf6,#a78bfa); display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 1.1rem; }
        ...
        <main class="main-content">
            <div class="top-nav">
                <div class="top-nav-left" style="display:flex;align-items:center;gap:12px;">
                    ...
                    <div><h1>Security Guards</h1><p>All registered guards in the system</p></div>
                </div>
            ...
            <div class="dashboard-content">
                ...
                <div class="page-header-info">
                    <h2>Security Guards (<?= count($guards) ?>)</h2>
                    <p>All security personnel registered in the system.</p>
                </div>
                <div class="data-card">
                    <div class="table-wrapper-modern">
                        ...
                        <?php else: ?><div class="empty-state"><p>No guards found.</p></div><?php endif; ?>
                    </div>
                </div>
            </div>
        </main>
